    ...
    <Layout title="contact">
      <div className="sm:container sm:mx-auto pt-8 sm:pt-12 px-6 sm:px-0">
        ...
        <ul className="list-disc pl-6">
            <li><a target="_blank" rel="noopener noreferrer" href="https://ba-ka.org/discord">discord (server invite)</a> / datoyacx#5006 (toya)</li>
            <li><a target="_blank" rel="noopener noreferrer" href="mailto:tx@ba-ka.org">e-mail</a> / tx@ba-ka.org (tholut x)</li>
